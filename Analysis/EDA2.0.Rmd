...
```
**Comments** :  At a first glance, there are total `r nrow(raw_data)*ncol(raw_data)` observation across `r nrow(raw_data)` and `r ncol(raw_data)` variables in which 7 are categorical and 12 are numerical variables.
